    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class=" container ">
            ...
            <div class="text-center pt-15">
                <h1 class="h2 font-weight-bolder text-dark mb-6">
                    ¿Necesitas ayuda?
                </h1>
                <div class="h4 text-dark-50 font-weight-normal">
                    Envia un corre de ayuda a uno de nuestro expertos en SILABO.
                </div>
                <div class="row">
                    <div class="offset-md-3 col-md-6">
                        <span class="svg-icon svg-icon-full">
                            <!--begin::Svg Icon | path:assets/media/svg/illustrations/contact.svg--><svg
                ...
                <form class="form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email"
                                        class="form-control form-control-solid form-control-lg"
                                        placeholder="Ingresa tu correo electrónico" value="Instituto@uac.cl" />
                                </div>
                                <!--end::Input-->
                    ...
                    <div class="card-footer">
                        <div class="row">
                            ...
                            <div class="col-xl-6">
                                <button type="reset"
                                    class="btn btn-primary font-weight-bold mr-2">Enviar</button>
                                <button type="reset"
                                    class="btn btn-clean font-weight-bold">Cancelar</button>
                            </div>
                            <div class="col-xl-3"></div>
                        </div>
                    </div>
                            ...
                            <div class="d-flex align-items-center justify-content-between p-4">
                                ...
                                <div class="d-flex flex-column mr-5">
                                    <a href="#" class="h4 text-dark text-hover-primary mb-5">
                                        O comuníquese con nosotros por chat en vivo
                                    </a>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between p-4">
                                ...
                                <div class="d-flex flex-column mr-5">
                                    ...
                                    <p class="text-dark-50">
                                        Respondemos desde las 10:00 a 13:00 y de 15:00 a 19:00
                                    </p>
                                </div>
                                <!--end::Content-->
                                ...
                                <div class="ml-6 flex-shrink-0">
                                    <a href="#"
                                        class="btn font-weight-bolder text-uppercase font-size-lg btn-success py-3 px-6">+569 62481978</a>
                                </div>
                                <!--end::Button-->
                            </div>
                        </div>
