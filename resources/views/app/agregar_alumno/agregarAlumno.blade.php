                                            ...
                                            <div class="row justify-content-center">
                                                <div class="col-xl-9">
                                                    ...
                                                    <div class="my-5 step" data-wizard-type="step-content" data-wizard-state="current">
                                                        <h5 class="text-dark font-weight-bold mb-10">Detalles del perfil del alumno:</h5>
                                                        <!--begin::Group-->
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-9 col-xl-9">
                                                                ...
                                                                <span class="form-text text-muted">Ingrese un número de teléfono válido (ejemplo: 9 91110023).</span>
                                                            </div>
                                                        </div>
                                                        <!--end::Group-->
                                                        <!--begin::Group-->
                                                        ...
                                                        <!--begin::Group-->
                                                        <div class="form-group row">
                                                            <label class="col-form-label col-xl-3 col-lg-3">Carrera</label>
                                                            <div class="col-xl-9 col-lg-9 col-form-label">
                                                                <div class="radio-inline">
                                                                    <label class="radio">
                                                                        <input name="carrera" type="radio" />
                                                                        <span></span>
                                                                        Contabilidad
                                                                    </label>
                                                                    <label class="radio">
                                                    ...
                                                    <div class="my-5 step" data-wizard-type="step-content">
                                                        <h5 class="mb-10 font-weight-bold text-dark">Revisar información y enviar</h5>
                                                        ...
                                                        <div class="border-bottom mb-5 pb-5">
                                                            ...
                                                            <div class="line-height-xl">
                                                                Nombre alumno
                                                                <br /> Telefono: +569 99009900
                                                                <br /> Email: Alumno.mail@mail.com
                                                                <br /> Estalecimiento: Nombre establecimiento
                                                                <br /> Carrera: Administracion
                                                            </div>
                                                        </div>
                                                        <!--end::Item-->
