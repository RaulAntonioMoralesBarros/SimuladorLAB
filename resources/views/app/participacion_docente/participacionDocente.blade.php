                        ...
                        <div class="flex-grow-1">
                            ...
                            <div class="d-flex align-items-center justify-content-between flex-wrap mt-2">
                                ...
                                <div class="mr-3">
                                    ...
                                    <a href="#" class="d-flex align-items-center text-dark text-hover-primary font-size-h5 font-weight-bold mr-3">
                                        Cosme Fulanito <i class="flaticon2-correct text-success icon-md ml-2"></i>
                                    </a>
                                    <!--end::Name-->
                                    ...
                                    <div class="d-flex flex-wrap my-2">
                                        <a href="#" class="text-muted text-hover-primary font-weight-bold mr-lg-8 mr-5 mb-lg-0 mb-2">
                                            <span class="svg-icon svg-icon-md svg-icon-gray-500 mr-1">
                                                ...
                                                <!--end::Svg Icon--></span> cosmefulanito@email.com
                                        </a>
                                        <a href="#" class="text-muted text-hover-primary font-weight-bold mr-lg-8 mr-5 mb-lg-0 mb-2">
                                            <span class="svg-icon svg-icon-md svg-icon-gray-500 mr-1">
                                ...
                                <div class="my-lg-0 my-1">
                                    <a href="#emergente" class="btn btn-sm btn-primary font-weight-bolder text-uppercase" data-toggle="modal">Comentar</a>
                                </div>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <a href="#" class="btn btn-sm btn-primary font-weight-bolder text-uppercase" data-toggle="modal">Enviar</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="d-flex align-items-center flex-wrap justify-content-between">
                                ...
                                <div class="flex-grow-1 font-weight-bold text-dark-50 py-2 py-lg-2 mr-5">
                                    Lorem, ipsum dolor sit amet consectetur adipisicing elit. Aut cupiditate vel quasi dicta eligendi labore minus accusamus voluptas provident nisi qui a, atque odio praesentium itaque quod aspernatur dolore officiis!
                                </div>
                                <!--end::Description-->
                        ...
                        <div class="flex-grow-1">
                            ...
                            <div class="d-flex align-items-center justify-content-between flex-wrap mt-2">
                                ...
                                <div class="mr-3">
                                    <!--begin::Name-->
                                    <a href="#" class="d-flex align-items-center text-dark text-hover-primary font-size-h5 font-weight-bold mr-3">
                                        Matt Pears <i class="flaticon2-correct text-success icon-md ml-2"></i>
                                    </a>
                                    <!--end::Name-->
                                    ...
                                    <div class="d-flex flex-wrap my-2">
                                        <a href="#" class="text-muted text-hover-primary font-weight-bold mr-lg-8 mr-5 mb-lg-0 mb-2">
                                            <span class="svg-icon svg-icon-md svg-icon-gray-500 mr-1">
                                                ...
                                                <!--end::Svg Icon--></span> matt@stream.com
                                        </a>
                                        <a href="#" class="text-muted text-hover-primary font-weight-bold mr-lg-8 mr-5 mb-lg-0 mb-2">
                                            <span class="svg-icon svg-icon-md svg-icon-gray-500 mr-1">
                                                <!--begin::Svg Icon | path:assets/media/svg/icons/General/Lock.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            ...
                            <div class="d-flex align-items-center flex-wrap justify-content-between">
                                <!--begin::Description-->
                                <div class="flex-grow-1 font-weight-bold text-dark-50 py-2 py-lg-2 mr-5">
                                    Lorem, ipsum dolor sit amet consectetur adipisicing elit. In saepe id<br>
                                    reprehenderit sunt possimus amet itaque nobis, eaque, a quasi est fuga?<br>
                                    Itaque excepturi reprehenderit ducimus dolore eaque veniam pariatur!
                                </div>
                                <!--end::Description-->
